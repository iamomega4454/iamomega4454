...
> **Building practical software with AI, computer vision and backend technologies.**

</div>

<table align="center">
<tr>
<td align="center" width="33%"><b>🤖 AI</b><br/>Assistive AI<br/>Conversational AI</td>
<td align="center" width="33%"><b>👁️ Computer Vision</b><br/>Object Detection<br/>Face Recognition</td>
<td align="center" width="33%"><b>⚙️ Backend</b><br/>FastAPI<br/>Flask</td>
</tr>
</table>
...
### 🧠 <a href="https://github.com/iamomega4454/A.U.R.A">A.U.R.A</a>

**AI Assistive User Reminder Application**

An assistive healthcare platform combining conversational AI, face recognition, reminders, memory support, SOS alerts, live location tracking and caregiver support.

`React Native` `FastAPI` `MongoDB`  
`Firebase` `FaceNet` `OpenCV` `Gemini`

</td>
<td width="50%" valign="top">

### 👁️ <a href="https://github.com/iamomega4454/Haptix">Haptix Vision</a>

Laptop-hosted object detection using an Android phone as the camera source, with haptic receivers for spatial feedback.

`Python` `Flask` `YOLO` `JavaScript`  
`Docker` `SSE`
...
### 📝 <a href="https://github.com/iamomega4454/Mr.Note">Mr.Note</a>

A file and note vault project represented in the GitHub portfolio.
...
<a href="https://github.com/iamomega4454/A.U.R.A">🧠 A.U.R.A</a> ·
<a href="https://github.com/iamomega4454/Haptix">👁️ Haptix</a> ·
<a href="https://github.com/iamomega4454/Mr.Note">📝 Mr.Note</a> ·
<a href="https://github.com/iamomega4454/SINGHAM">🛡️ SINGHAM</a> ·
<a href="https://github.com/iamomega4454/Operation-Mini">⚙️ Operation-Mini</a>
